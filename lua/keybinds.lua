...
vim.api.nvim_set_keymap('n', '<F1>', ':Telescope live_grep<Cr>', { noremap = true, silent = true })
...
-- undo tree stuff
vim.api.nvim_set_keymap('n', '<F3>', ':UndotreeToggle<Cr>:UndotreeFocus<Cr>', { noremap = true, silent = true })
